...
| 07 | Disaster recovery | Backup metadata DB, Fernet key rotation, RTO/RPO tiers |
| 08 | Security hardening | NetworkPolicies, per-component DB users, OWASP Top 10, IRSA |
