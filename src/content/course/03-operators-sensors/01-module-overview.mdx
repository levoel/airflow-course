...
| 05 | BranchPythonOperator + ShortCircuit | Branching tasks, trigger rules |
| 06 | TaskGroup vs SubDAG | TaskGroup mechanics, почему SubDAG anti-pattern |
| 07 | Provider architecture | Entry points, hooks, custom provider package |
